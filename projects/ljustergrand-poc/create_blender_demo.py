...
def write_report(data, renderer_name):
    ...
    lines = []
    lines.append("# Stockholm Urban Massing POC — Ljustergränd 5 / Hammarbyhöjden-Skanstull edge")
    lines.append("")
    lines.append("## Site description")
    lines.append("Conceptual one-day massing demo for Ljustergränd 5, 116 68 Stockholm, near the Hammarby/Södermalm edge. Work is in EPSG:3006 / SWEREF 99 TM using a local WGS84 bbox around geocoded Ljustergränd 5: 18.0764,59.3004,18.0895,59.3094.")
    lines.append("")
    ...
    lines.append("```bash")
    lines.append("cd ~/projects/ljustergrand-poc")
...
def main():
    ...
    mats = {
        ...
        "V4": make_mat("V4 muted green", (0.34, 0.56, 0.42, 1.0)),
        "V5": make_mat("V5 pale ochre", (0.82, 0.67, 0.34, 1.0)),
    }
