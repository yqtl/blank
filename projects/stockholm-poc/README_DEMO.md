# Stockholm Urban Massing POC Demo

This demo builds a self-contained local pipeline for a conceptual LLM-driven urban massing workflow at Skanstull / Hammarby Sluss, Stockholm. It fetches or synthesizes OSM context, works in EPSG:3006 / SWEREF 99 TM, selects an approximate empty plot, generates three parametric massing variants, exports GLB models, renders PNG images, and writes a report.
...
- `out/V1.glb`, `out/V2.glb`, `out/V3.glb` — variant GLB exports
- `out/V1.png`, `out/V2.png`, `out/V3.png` — rendered demo images
