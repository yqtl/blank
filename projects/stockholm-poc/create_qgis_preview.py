...
def render_matplotlib():
    ...
    minx, miny = tr.transform(18.0695, 59.3050)
    maxx, maxy = tr.transform(18.0782, 59.3105)
    ...
    ax.set_aspect("equal")
    ax.set_axis_off()
    ax.text(0.02, 0.98, "Skanstull / Hammarby Sluss — EPSG:3006", transform=ax.transAxes, va="top", ha="left", fontsize=9, color="#222222", bbox={"facecolor":"white", "alpha":0.65, "edgecolor":"none", "pad":3})
